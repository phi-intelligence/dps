...
function PipeScene() {
  return (
    <>
      ...
      <FlowParticle points={[[-10, 0, -1.5], [10, 0, -1.5]]} color="#d4af37" speed={0.12} delay={0} />
      <FlowParticle points={[[-10, 0, -1.5], [10, 0, -1.5]]} color="#d4af37" speed={0.12} delay={4.5} />
      ...
      <FlowParticle points={[[5, -5, -1.8], [5, 5, -1.8]]} color="#d4af37" speed={0.08} delay={1.5} />
  ...
  return (
    <div className="absolute inset-0 z-0 pointer-events-none">
      ...
      >
        ...
        <pointLight position={[-4, 2, 3]} intensity={0.8} color="#d4af37" distance={10} />
