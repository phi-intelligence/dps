        ...
        <AnimatePresence mode="wait">
          {open && hasOpened && (
            <motion.div
              ...
              className="fixed bottom-24 right-6 w-[calc(100vw-3rem)] sm:w-[420px] h-[600px] max-h-[80vh] rounded-3xl z-[101]"
            >
              <Suspense
                fallback={
                  <div className="w-full h-full bg-brand-surface border border-brand-card-border rounded-3xl flex items-center justify-center">
