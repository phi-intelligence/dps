...
import { CORE_SERVICES_IMAGES_COMMERCIAL, CORE_SERVICE_COMMERCIAL_HREFS } from "@/lib/constants";
...
export default function CommercialServicesPage() {
  ...
  return (
    <div className="bg-[#f2ede3] text-brand-text overflow-x-hidden min-h-screen">
      ...
      {/* Commercial overview + core services cards */}
      <section className="relative py-24 md:py-28 overflow-hidden bg-[#f7f3ea]">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <div className="inline-flex items-center gap-2 border border-[#e0d3b8]/80 bg-white/80 rounded-full px-5 py-2 mb-6 shadow-sm">
              <Building2 size={14} className="text-[#b8963a]" />
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-8">
              {(["Mechanical Services", "Electrical Services", "Gas Services"] as const).map((label, i) => (
                ...
                >
                  ...
                  >
                    <Image
                      src={CORE_SERVICES_IMAGES_COMMERCIAL[label] ?? "/images/core-services/mechanical.png"}
                      alt={label}
                      fill
      ...
      {/* Need Commercial Support strip — dark luxury band */}
