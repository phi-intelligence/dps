...
import { Phone, Mail, Clock, AlertTriangle, Cpu, Activity, Zap, MapPin } from "lucide-react";
  ...
  return (
    <div className="bg-brand-surface text-brand-text min-h-screen">
      <PageHero
        ...
        subtitle="Operational command center. Deploy an engineer or transmit system diagnostics via the secure portal."
        breadcrumbs={[{ label: "Core", href: "/" }, { label: "Contact" }]}
        compact
      />

      {/* Main Quote Form & Details */}
      <section className="py-24" aria-label="Quote request form">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-24 items-start">

            {/* Left: Contact Info Nodes */}
            <div className="lg:col-span-2 space-y-10">
              ...
              >
                ...
                <h2 className="font-technical font-extrabold text-brand-text text-xl mb-4 tracking-widest uppercase">Direct Audio</h2>
                <a
                ...
                <p className="text-brand-muted text-[10px] font-technical uppercase tracking-[0.2em]">Priority line for emergency deployment.</p>
              </motion.div>
              ...
              >
                ...
                <h2 className="font-technical font-extrabold text-brand-text text-xl mb-4 tracking-widest uppercase">Data Transmission</h2>
                <a
                ...
                <p className="text-brand-muted text-[10px] font-technical uppercase tracking-[0.2em]">Response within one operational cycle (24h).</p>
              </motion.div>
              ...
              >
                ...
                <h2 className="font-technical font-extrabold text-brand-text text-xl mb-6 tracking-widest uppercase">System Uptime</h2>
                <div className="space-y-4 text-[10px] font-technical font-bold uppercase tracking-[0.3em] text-brand-muted">
                  ...
                  <div className="flex justify-between text-brand-red animate-pulse">
                    <span>Emergency</span>
            ...
            <div className="lg:col-span-3 bg-brand-navy rounded-[3rem] p-12 md:p-20 shadow-2xl border border-brand-card-border relative overflow-hidden">
              ...
              <div className="relative z-10">
                <div className="inline-flex items-center gap-2 px-3 py-1 rounded-md border border-brand-red/20 bg-brand-red/5 mb-8">
                  ...
                  <span className="text-[9px] font-technical font-bold text-brand-red uppercase tracking-[0.3em]">Request Protocol</span>
                </div>

                <h2 className="text-3xl md:text-5xl font-technical font-extrabold text-brand-text mb-6 tracking-widest uppercase leading-none">Transmission Portal</h2>
                <p className="text-brand-muted text-xs font-light leading-relaxed mb-16 uppercase tracking-wider max-w-xl">
                  Input system requirements to generate a secure, transparent quote. All transmissions are encrypted and obligation-free.
                </p>
      ...
      <section className="py-24 bg-brand-red border-y border-white/10 relative overflow-hidden" aria-label="Emergency contact">
          ...
          <div className="flex items-center gap-8">
            ...
            <div>
              ...
              <p className="text-white/80 text-[10px] font-technical font-bold uppercase tracking-[0.4em]">
                Bypass standard queue. Direct engineering hotline for immediate bypass.
              </p>
            </div>
          </div>
          <a
